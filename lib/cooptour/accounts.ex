defmodule Cooptour.Accounts do
  @moduledoc """
  ...
  alias Cooptour.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Cooptour.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Cooptour.Accounts.User.password_changeset/3` for a list of supported options.
