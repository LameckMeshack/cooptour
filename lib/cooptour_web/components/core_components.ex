defmodule CooptourWeb.CoreComponents do
  @moduledoc """
  ...
  attr :flash, :map, doc: "the map of flash messages to display"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CooptourWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CooptourWeb.Gettext, "errors", msg, opts)
    end
  end
